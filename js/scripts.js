...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["I am a Master Student.", "I like to think about Stuff.", "Like the Internet, Social Media, and Digital Humanities"],    /* You can change the home section typing text from
